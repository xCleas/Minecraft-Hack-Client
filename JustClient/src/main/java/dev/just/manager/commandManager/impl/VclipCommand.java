...
public class VclipCommand extends Command {
   ...
   private void teleport(double offset) {
      if (offset == 0.0) {
         ClientManager.message(Formatting.RED + I0O1l0I1.b("SGF0YSEg") + Formatting.WHITE + I0O1l0I1.b("VXlndW4gYm/FnyBhbGFuIGJ1bHVuYW1hZMSxLg=="));
      } else {
         ...
         ClientManager.message(
            Formatting.GREEN
               + I0O1l0I1.b("QmHFn2FyxLFsxLEhIA==")
               + Formatting.WHITE
               + (offset > 0.0 ? I0O1l0I1.b("WXVrYXLEsXlh") : I0O1l0I1.b("QcWfYcSfxLF5YQ=="))
               + " "
               + Formatting.GOLD
               + (int)Math.abs(offset)
               + Formatting.WHITE
               + I0O1l0I1.b("IGJsb2sgxLHFn8SxbmxhbmTEsW4u")
         );
      }
   }
