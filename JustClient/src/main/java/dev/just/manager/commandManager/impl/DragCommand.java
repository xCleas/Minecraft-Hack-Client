...
public class DragCommand extends Command {
   ...
   public void execute(LiteralArgumentBuilder<CommandSource> root) {
      root.then(literal("reset").executes(ctx -> {
         ...
         ClientManager.message(Formatting.GREEN + I0O1l0I1.b("RWtyYW4gw7bEn2VsZXJpbmluIHBvemlzeW9ubGFyxLEgc8SxZsSxcmxhbmTEsS4="));
         return 1;
      }));
      root.then(literal("save").executes(ctx -> {
         Manager.DRAG_MANAGER.save();
         ClientManager.message(Formatting.GREEN + I0O1l0I1.b("RWtyYW4gw7bEn2VsZXJpbmluIHBvemlzeW9ubGFyxLEga2F5ZGVkaWxkaS4="));
         return 1;
      }));
   }
}
