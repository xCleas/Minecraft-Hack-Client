   ...
   public void execute(LiteralArgumentBuilder<CommandSource> root) {
      root.then(literal("add").then(arg("item", StringArgumentType.word()).suggests((ctx, builder) -> {
         ...
         if (Manager.CHESTSTEALER_MANAGER.addItem(itemName)) {
            ClientManager.message(Formatting.GREEN + itemName + I0O1l0I1.b("IGXFn3lhc8SxIENoZXN0U3RlYWxlciBsaXN0ZXNpbmUgZWtsZW5kaS4="));
         } else {
            ClientManager.message(Formatting.RED + I0O1l0I1.b("RcWfeWEgZWtsZW5lbWVkaTog") + itemName);
         }
      ...
      root.then(literal("remove").then(arg("item", StringArgumentType.word()).suggests((ctx, builder) -> {
         ...
         if (Manager.CHESTSTEALER_MANAGER.removeItem(itemName)) {
            ClientManager.message(Formatting.GREEN + itemName + I0O1l0I1.b("IGXFn3lhc8SxIENoZXN0U3RlYWxlciBsaXN0ZXNpbmRlbiBrYWxkxLFyxLFsZMSxLg=="));
         } else {
            ClientManager.message(Formatting.RED + I0O1l0I1.b("RcWfeWEgbGlzdGVkZW4ga2FsZMSxcsSxbGFtYWTEsTog") + itemName);
         }
      ...
      root.then(literal("list").executes(ctx -> {
         if (Manager.CHESTSTEALER_MANAGER.getWhitelist().isEmpty()) {
            ClientManager.message(Formatting.RED + I0O1l0I1.b("TGlzdGVkZSBla2xpIGXFn3lhIGJ1bHVubXV5b3Ih"));
         } else {
            ClientManager.message(Formatting.GREEN + I0O1l0I1.b("QmV5YXogbGlzdGVkZWtpIGXFn3lhbGFyOg=="));
