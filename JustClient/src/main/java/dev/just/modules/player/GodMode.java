   ...
   public void onEvent(Event event) {
      if (event instanceof EventPacket eventPacket && eventPacket.getPacket() instanceof GameMessageS2CPacket packet) {
         ...
         if (message.contains("PVP modundayken isinlanamazsiniz")
            || message.contains(I0O1l0I1.b("UFZQIG1vZHVuZGF5a2VuIMSxxZ/EsW5sYW5hbWF6c8SxbsSxeg=="))
            || message.contains("Farm warpina basariyla isinlandiniz!")
            || message.contains(I0O1l0I1.b("RmFybSB3YXJwxLFuYSBiYcWfYXLEsXlsYSDEscWfxLFubGFuZMSxbsSxeiE="))) {
      ...
      if (event instanceof EventUpdate) {
         if (this.timerUtil.hasTimeElapsed(8000L)) {
            ClientManager.message(
               Formatting.WHITE + I0O1l0I1.b("R29kTW9kZSBldGtpbmtlbg==") + Formatting.RED + I0O1l0I1.b("IEjEsMOHQsSwUiA=") + Formatting.WHITE + I0O1l0I1.b("ZcWfeWEgZGXEn2nFn3Rpcm1lIChzd2FwKSBrdWxsYW7EsWxhbWF6IQ==")
            );
         }
