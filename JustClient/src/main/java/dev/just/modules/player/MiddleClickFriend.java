   ...
   public void onEvent(Event event) {
      if (event instanceof EventMouse e
         ...
         if (Manager.FRIEND_MANAGER.isFriend(name)) {
            ...
            ClientManager.message(Formatting.RED + I0O1l0I1.b("U2lsaW5kaSEg") + Formatting.GOLD + name + Formatting.WHITE + I0O1l0I1.b("IGFya2FkYcWfIGxpc3Rlc2luZGVuIMOnxLFrYXLEsWxkxLEu"));
         } else {
            Manager.FRIEND_MANAGER.addFriend(name);
            ClientManager.message(Formatting.GREEN + I0O1l0I1.b("RWtsZW5kaSEg") + Formatting.GOLD + name + Formatting.WHITE + I0O1l0I1.b("IGFya2FkYcWfIGxpc3Rlc2luZSBla2xlbmRpLg=="));
         }
      }
   }
}
