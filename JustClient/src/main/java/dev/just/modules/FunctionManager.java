...
import dev.just.modules.combat.I0l1OI0l;
import dev.just.modules.combat.lI0l1OlI;
import dev.just.modules.combat.O0lI1l0O;
...
import dev.just.modules.combat.lI0O1I0l;
import dev.just.modules.combat.Ol0I1lO0;
import dev.just.modules.combat.l0OI1l0I;
import dev.just.modules.combat.I1l0OI1l;
import dev.just.modules.misc.AutoDuel;
import dev.just.modules.misc.AutoDuelBot;
import dev.just.modules.misc.ClientSounds;
import dev.just.modules.misc.lI0O1lOI;
...
import dev.just.modules.misc.O1lI0OlI;
...
public class FunctionManager {
   ...
   public final I1lO0Il1 attackAura;
   public final lI0l1OlI crystalAura;
   public final NoFriendDamage noFriendDamage;
   public final O0lI1l0O xbox;
   ...
   public final Ol0I1lO0 reach;
   public final l0OI1l0I triggerBot;
   public final I1l0OI1l aimAssist;

   public FunctionManager() {
      functions.addAll(
         Arrays.asList(
            new I0l1OI0l(),
            this.reach = new Ol0I1lO0(),
            this.triggerBot = new l0OI1l0I(),
            this.aimAssist = new I1l0OI1l(),
            this.targetStrafe = new TargetStrafe(),
            this.noFriendDamage = new NoFriendDamage(),
            this.autoExplosion = new AutoExplosion(),
            new AttackExtend(),
            this.attackAura = new I1lO0Il1(),
            this.crystalAura = new lI0l1OlI(),
            this.selfTrap = new SelfTrap(),
            this.autoPotion = new AutoPotion(),
            this.autoTotem = new AutoTotem(),
            new AutoSwap(),
            new SuperBow(),
            this.xbox = new O0lI1l0O(),
