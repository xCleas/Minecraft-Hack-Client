...
public class I1lO0Il1 extends Function {
   private final ModeSetting mode = new ModeSetting(
      I0O1l0I1.b("U2FsZMSxcsSxIE1vZHU="), I0O1l0I1.b("U3RhbmRhcnQ="), I0O1l0I1.b("U3RhbmRhcnQ="), I0O1l0I1.b("SGFzc2Fz"), I0O1l0I1.b("QWvEsWPEsQ=="), I0O1l0I1.b("RGluYW1paw=="), I0O1l0I1.b("U2VyaQ=="), I0O1l0I1.b("R2VsacWfbWnFnw=="), I0O1l0I1.b("QWx0ZXJuYXRpZg=="), I0O1l0I1.b("VnVydcWfIE9wdGltaXpl"), I0O1l0I1.b("R3JpbSBZYXLEsSBCeXBhc3M=")
   );
   private final MultiSetting targets = new MultiSetting(
      I0O1l0I1.b("SGVkZWYgU2XDp2ltaQ=="),
      Arrays.asList(I0O1l0I1.b("T3l1bmN1bGFy"), I0O1l0I1.b("TW9ibGFy"), I0O1l0I1.b("Q2FuYXZhcmxhcg==")),
      new String[]{I0O1l0I1.b("T3l1bmN1bGFy"), I0O1l0I1.b("WsSxcmhzxLF6bGFy"), I0O1l0I1.b("RG9zdGxhcg=="), I0O1l0I1.b("TW9ibGFy"), I0O1l0I1.b("Q2FuYXZhcmxhcg=="), I0O1l0I1.b("S8O2eWzDvGxlcg==")}
   );
   private final ModeSetting sort = new ModeSetting(I0O1l0I1.b("SGVkZWYgw5ZuY2VsacSfaQ=="), I0O1l0I1.b("Q2Fu"), I0O1l0I1.b("Q2Fu"), I0O1l0I1.b("TWVzYWZl"), I0O1l0I1.b("WsSxcmg="));
   private final MultiSetting setting = new MultiSetting(
      I0O1l0I1.b("U2FsZMSxcsSxIEF5YXJsYXLEsQ=="), Arrays.asList(I0O1l0I1.b("U2FkZWNlIEtyaXRpaw=="), I0O1l0I1.b("S2Fsa2FuIEvEsXLEsWPEsQ==")), new String[]{I0O1l0I1.b("U2FkZWNlIEtyaXRpaw=="), I0O1l0I1.b("S2Fsa2FuIEvEsXLEsWPEsQ=="), I0O1l0I1.b("S2Fsa2FuIETDvMWfw7xy")}
   );
   private final SliderSetting distance = new SliderSetting(I0O1l0I1.b("VnVydcWfIE1lbnppbGk="), 3.0, 1.8F, 6.0, 0.1F);
   private final SliderSetting rotateDistance = new SliderSetting(I0O1l0I1.b("T2Rha2xhbm1hIE1lc2FmZXNp"), 5.0, 0.0, 10.0, 0.1F);
   private final SliderSetting elytraDistance = new SliderSetting(I0O1l0I1.b("RWx5dHJhIFRlc3BpdCBNZW56aWxp"), 40.0, 0.0, 80.0, 1.0);
   private final SliderSetting predictionAmount = new SliderSetting(I0O1l0I1.b("VGFobWluIEhhc3Nhc2l5ZXRp"), 1.0, 0.0, 3.0, 0.1F);
   private final BooleanSetting predictFlyingTargetsOnly = new BooleanSetting(I0O1l0I1.b("U2FkZWNlIFXDp2FubGFyxLEgVGFraXAgRXQ="), true);
   private final BooleanSetting elytraEnabled = new BooleanSetting(I0O1l0I1.b("RWx5dHJhIERlc3RlxJ9p"), true);
   private final ModeSetting elytraMode = new ModeSetting(() -> this.elytraEnabled.get(), I0O1l0I1.b("U2FsZMSxcsSxIFRpcGk="), I0O1l0I1.b("U2VyaQ=="), I0O1l0I1.b("U2VyaQ=="), I0O1l0I1.b("QcSfxLFy"), "ElytraTarget");
   private final SliderSetting elytraRotationSpeed = new SliderSetting(
      I0O1l0I1.b("VGFraXAgSGFzc2FzaXlldGk="), 15.0, 5.0, 30.0, 0.5, () -> this.elytraEnabled.get() && !this.elytraMode.is("ElytraTarget")
   );
   private final SliderSetting elytraAimHeight = new SliderSetting(
      I0O1l0I1.b("SGVkZWYgT2RhayBOb2t0YXPEsQ=="), 0.5, 0.0, 1.0, 0.01F, () -> this.elytraEnabled.get() && !this.elytraMode.is("ElytraTarget")
   );
   private final BooleanSetting elytraPredict = new BooleanSetting(
      I0O1l0I1.b("S29udW0gS2VzdGlyaW1p"), true, () -> this.elytraEnabled.get() && !this.elytraMode.is("ElytraTarget")
   );
   private final SliderSetting elytraPredictFactor = new SliderSetting(
      I0O1l0I1.b("S2VzdGlyaW0gS2F0c2F5xLFzxLE="), 0.5, 0.0, 2.0, 0.05F, () -> this.elytraEnabled.get() && !this.elytraMode.is("ElytraTarget") && this.elytraPredict.get()
   );
   private final SliderSetting elytraReach = new SliderSetting(I0O1l0I1.b("SGF2YSBWdXJ1xZ8gTWVuemlsaQ=="), 6.5, 4.0, 12.0, 0.1F, () -> this.elytraEnabled.get());
   ...
   private final BooleanSetting elytraFastHitbox = new BooleanSetting(I0O1l0I1.b("R2VuacWfIEhpdGJveA=="), true, () -> this.elytraEnabled.get() && this.elytraMode.is(I0O1l0I1.b("SMSxemzEsQ==")));
   private final SliderSetting elytraHitboxSize = new SliderSetting(
      I0O1l0I1.b("SGl0Ym94IEJveXV0dQ=="), 0.3F, 0.1F, 1.0, 0.05F, () -> this.elytraEnabled.get() && this.elytraMode.is(I0O1l0I1.b("SMSxemzEsQ==")) && this.elytraFastHitbox.get()
   );
   private final BooleanSetting elytraTargetIntegration = new BooleanSetting(
      I0O1l0I1.b("VcOndcWfIE1vZMO8bMO8IEVudGVncmVzaQ=="), true, () -> this.elytraEnabled.get() && this.elytraMode.is("ElytraTarget")
   );
   private final SliderSetting snapSpeed = new SliderSetting(I0O1l0I1.b("S2lsaXRsZW5tZSBIxLF6xLE="), 150.0, 50.0, 300.0, 50.0, () -> this.mode.is(I0O1l0I1.b("SMSxemzEsQ==")));
   private final BindBooleanSetting onlySpaceCritical = new BindBooleanSetting(I0O1l0I1.b("U2FkZWNlIFrEsXBsYXJrZW4gVnVy"), false, () -> this.setting.get(I0O1l0I1.b("U2FkZWNlIEtyaXRpaw==")));
   private final BooleanSetting noAttackIfEat = new BooleanSetting(I0O1l0I1.b("WWVtZWsgWWVya2VuIER1cmFrbGF0"), false);
   private final BooleanSetting raycast = new BooleanSetting("Raycast", false);
   public final BooleanSetting correction = new BooleanSetting(I0O1l0I1.b("SGFyZWtldCBEw7x6ZWx0bWU="), true);
   public final ModeSetting correctionType = new ModeSetting(() -> this.correction.get(), I0O1l0I1.b("RMO8emVsdG1lIFTDvHLDvA=="), I0O1l0I1.b("U2VyYmVzdA=="), I0O1l0I1.b("U2VyYmVzdA=="), I0O1l0I1.b("T2Rhaw=="));
   private final ModeSetting sprintreset = new ModeSetting(I0O1l0I1.b("S2/Fn3UgU8SxZsSxcmxhbWE="), "Rage", "Rage", "Legit", I0O1l0I1.b("S2FwYWzEsQ=="));
   ...
   protected void onDisable() {
      if (this.target != null && this.isValidTarget(this.target)) {
         ...
         if (!modeName.equals(I0O1l0I1.b("QWvEsWPEsQ==")) && !modeName.equals("Hassas") && !modeName.equals("Standart")) {
   ...
   private boolean isValidTarget(LivingEntity entity) {
      ...
      if (l1O0I1lO.opaqueFalse()) {
         return entity.age > lO1I0l1O.i(9999);
      }

      int score = evaluateTargetScore(entity);
      l1O0I1lO.fakeHandler();

      return I1lO0l1I.threshold(score, lO1I0l1O.i(5));
   }
   ...
   private int evaluateTargetScore(LivingEntity entity) {
      ...
      // Basic validity
      score += I1lO0l1I.score(entity != null);
      score += I1lO0l1I.score(EntityHelper.checkAlive(entity));
      score += I1lO0l1I.score(EntityHelper.checkNotSelf(entity));

      if (score < lO1I0l1O.i(3)) return 0;
      ...
      boolean inRange = I1lO0l1I.or(
         I1lO0l1I.not(I1lO0l1I.greaterThan((int)(dist * 10), (int)(attackRange * 10))),
         I1lO0l1I.and(
            I1lO0l1I.greaterThan((int)(detectRange * 10), 0),
            I1lO0l1I.not(I1lO0l1I.greaterThan((int)(dist * 10), (int)(detectRange * 10)))
         )
      );
      score += I1lO0l1I.score(inRange);

      // Fake check
      if (l1O0I1lO.opaqueFalse()) {
         score += entity.getId() % lO1I0l1O.i(100);
      }

      // AntiBot check
      score += I1lO0l1I.score(I1lO0l1I.not(Manager.FUNCTION_MANAGER.antiBot.check(entity)));
   ...
   private int checkEntityType(LivingEntity entity) {
      ...
      if (l1O0I1lO.opaqueFalse()) {
         return entity.hashCode() % lO1I0l1O.i(10);
      }

      if (entity instanceof PlayerEntity) {
         if (!this.targets.get("Oyuncular")) return -10;
         if (!this.targets.get(I0O1l0I1.b("QXJrYWRhxZ9sYXI=")) && Manager.FRIEND_MANAGER.isFriend(entity.getName().getString())) return -10;
         return 1;
      }
      ...
      if (entity instanceof VillagerEntity) {
         return this.targets.get(I0O1l0I1.b("S8O2eWzDvGxlcg==")) ? 1 : -10;
      }
   ...
   private LivingEntity findTarget() {
      ...
      if (sortMode.equals(I0O1l0I1.b("U2HEn2zEsWs="))) {
      ...
      } else if (sortMode.equals(I0O1l0I1.b("WsSxcmg="))) {
   ...
   private void handleAttackAndRotation(LivingEntity t) {
      ...
      if (this.mode.is("Grim AC Bypass")) {
      ...
      } else if (this.mode.is(I0O1l0I1.b("xLBsZXJpIFNldml5ZQ==")) || this.mode.is(I0O1l0I1.b("QWx0ZXJuYXRpZg=="))) {
      ...
      } else if (this.mode.is(I0O1l0I1.b("VnVydcWfIE9wdGltaXpl"))) {
         ...
         Manager.ROTATION.set(mc.player.getYaw(), mc.player.getPitch());
      } else if (this.mode.is(I0O1l0I1.b("QWvEsWPEsQ=="))) {
         ...
         if (this.mode.is(I0O1l0I1.b("SMSxemzEsQ=="))) {
   ...
   private void handleElytraCombat(LivingEntity target, boolean canAttackNow, boolean passRay, boolean noPotion) {
      if (target != null) {
         ...
         } else if (this.elytraMode.is(I0O1l0I1.b("SMSxemzEsQ=="))) {
   ...
   private void handleElytraTargetCombat(LivingEntity target, ElytraTarget ely, boolean canAttackNow, boolean noPotion) {
      if (target != null) {
         if (ely.mode.is(I0O1l0I1.b("R2VsacWfbWnFnw=="))) {
   ...
   private float getElytraRotationSpeed() {
      ...
      if (var1.equals(I0O1l0I1.b("SMSxemzEsQ=="))) {
         return this.elytraRotationSpeed.get().floatValue();
      } else if (var1.equals(I0O1l0I1.b("QcSfxLFy"))) {
   ...
   public void attackTarget(PlayerEntity player) {
      ...
      if (this.setting.get(I0O1l0I1.b("S2Fsa2FuIETDvMWfw7xy")) && mc.player.isBlocking()) {
      ...
      if (!this.sprintreset.is("Legit") || !mc.player.isSprinting() && !this.canAttack() || !mc.player.isSprinting()) {
         ...
         if (elytraTarget != null && elytraTarget.mode.is(I0O1l0I1.b("R2VsacWfbWnFnw=="))) {
         ...
         if (this.setting.get(I0O1l0I1.b("S2Fsa2FuIEvEsXLEsWPEsQ=="))) {
   ...
   private boolean canAttack() {
      ...
      if (l1O0I1lO.opaqueFalse()) {
         return mc.player.age % lO1I0l1O.i(2) == 0;
      }

      int checks = runAttackChecks();
      l1O0I1lO.fakeHandler();

      return I1lO0l1I.threshold(checks, lO1I0l1O.i(3));
   }
   ...
   private int runAttackChecks() {
      ...
      // Eating check
      boolean eating = I1lO0l1I.and(
         this.noAttackIfEat.get(),
         I1lO0l1I.and(mc.player.isUsingItem(), I1lO0l1I.not(mc.player.getActiveItem().isOf(Items.SHIELD)))
      );
      score += I1lO0l1I.score(I1lO0l1I.not(eating));
      ...
      boolean cooldownReady = I1lO0l1I.or(hasMace, cooldown >= 0.9F);
      score += I1lO0l1I.score(cooldownReady);
      ...
      score += I1lO0l1I.score(I1lO0l1I.not(restricted));
   ...
   private int checkCriticalCondition() {
      ...
      if (l1O0I1lO.opaqueFalse()) {
         return mc.player.age % lO1I0l1O.i(5);
      }
