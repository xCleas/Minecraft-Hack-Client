...
public class CrossHair extends Function {
   private final SliderSetting attackSetting = new SliderSetting(I0O1l0I1.b("VnVydcWfIEdlbmnFn2xlbWVzaQ=="), 6.0, 0.0, 20.0, 1.0);
   private final SliderSetting indentSetting = new SliderSetting(I0O1l0I1.b("TWVya2V6ZSBZYWvEsW5sxLFr"), 2.0, 0.0, 5.0, 1.0);
   private final SliderSetting size1Setting = new SliderSetting(I0O1l0I1.b("w4dpemkgVXp1bmx1xJ91"), 6.0, 2.0, 10.0, 1.0);
   private final SliderSetting size2Setting = new SliderSetting(I0O1l0I1.b("w4dpemkgS2FsxLFubMSxxJ/EsQ=="), 2.0, 2.0, 4.0, 1.0);
