...
public class NameTags extends Function {
   public final MultiSetting tags = new MultiSetting(I0O1l0I1.b("VmFybMSxa2xhcg=="), Arrays.asList(I0O1l0I1.b("T3l1bmN1bGFy")), new String[]{I0O1l0I1.b("T3l1bmN1bGFy"), I0O1l0I1.b("WWVyZGVraSBFxZ95YWxhcg==")});
   private final BooleanSetting armorRender = new BooleanSetting(I0O1l0I1.b("RcWfeWFsYXLEsSBHw7ZzdGVy"), true, () -> this.tags.get(I0O1l0I1.b("T3l1bmN1bGFy")));
   private final BooleanSetting effectRender = new BooleanSetting(I0O1l0I1.b("RWZla3RsZXJpIEfDtnN0ZXI="), true, () -> this.tags.get(I0O1l0I1.b("T3l1bmN1bGFy")));
   private final BooleanSetting enchantRender = new BooleanSetting(I0O1l0I1.b("QsO8ecO8bGVyaSBHw7ZzdGVy"), true, () -> this.tags.get(I0O1l0I1.b("T3l1bmN1bGFy")));
   private final BooleanSetting sphereRender = new BooleanSetting(I0O1l0I1.b("w5Z6ZWwgxLBzaW1sZXJpIEfDtnN0ZXI="), true, () -> this.tags.get(I0O1l0I1.b("T3l1bmN1bGFy")));
   private final BooleanSetting shulkerCheck = new BooleanSetting(I0O1l0I1.b("U2h1bGtlciDEsGNlcmnEn2luaSBHw7ZzdGVy"), true, () -> this.tags.get(I0O1l0I1.b("WWVyZGVraSBFxZ95YWxhcg==")));
   ...
   static {
      ...
      tmp.add("Koruma");
      tmp.add("Unbreaking");
      tmp.add(I0O1l0I1.b("S8SxcsSxbG1hemzEsWs="));
      tmp.add("Looting");
      tmp.add("Ganimet");
      tmp.add("Fortune");
      tmp.add("Servet");
      ...
      tmp.add("Verimlilik");
      tmp.add("Power");
      tmp.add(I0O1l0I1.b("R8O8w6c="));
      tmp.add("Feather Falling");
      tmp.add(I0O1l0I1.b("VMO8ecO8bXPDvA=="));
      tmp.add("Thorns");
      tmp.add("Dikenler");
      tmp.add("Silk Touch");
      tmp.add(I0O1l0I1.b("xLBwZWtzaQ=="));
      tmp.add("Respiration");
      tmp.add(I0O1l0I1.b("U29sdW5nYcOn"));
      tmp.add("Mending");
      tmp.add("Tamir");
      tmp.add("Knockback");
      tmp.add("Savurma");
   ...
   private void handleRenderInternal(EventRender2D e) {
      l1O0I1lO.fakeHandler();
      if (l1O0I1lO.opaqueTrue() && this.tags.get(I0O1l0I1.b("T3l1bmN1bGFy"))) {
         this.renderPlayers(e);
      }

      if (l1O0I1lO.opaqueTrue() && this.tags.get(I0O1l0I1.b("WWVyZGVraSBFxZ95YWxhcg=="))) {
         this.renderItems(e);
      }
   }
