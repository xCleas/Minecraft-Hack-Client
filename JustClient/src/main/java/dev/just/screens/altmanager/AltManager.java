...
public class AltManager extends Screen implements IMinecraft {
   ...
   private final String title = I0O1l0I1.b("SGVzYXAgWcO2bmV0aWNpc2k=");
   private int shakeTime = 0;
   private float shakeOffsetY = 0.0F;
   private boolean showConfirmDialog = false;

   public AltManager(Screen parent) {
      super(Text.of(I0O1l0I1.b("SGVzYXAgWcO2bmV0aWNpc2k=")));
      this.parent = parent;
   }
   ...
   public void render(DrawContext drawContext, int mouseX, int mouseY, float delta) {
      ...
      int titleWidth = (int)FontUtils.sf_bold[48].getWidth(I0O1l0I1.b("SGVzYXAgWcO2bmV0aWNpc2k="));
      ...
      FontUtils.sf_bold[48]
         .renderAnimatedGradientText(
            drawContext.getMatrices(), I0O1l0I1.b("SGVzYXAgWcO2bmV0aWNpc2k="), titleX, titleY, ColorUtil.getColorStyle(30.0F), ColorUtil.getColorStyle(260.0F), time
         );
      ...
      if (!this.isTyping) {
         StringBuilder placeholder = new StringBuilder(I0O1l0I1.b("S3VsbGFuxLFjxLEgYWTEsSBnaXJpbg=="));
      ...
      FontUtils.sf_medium[18]
         .centeredDraw(drawContext.getMatrices(), I0O1l0I1.b("U2XDp2lsaSBoZXNhcDog") + accountName, (float)centerX, (float)(buttonsY + inputHeight + 30), -1);
      FontUtils.sf_medium[18]
         .centeredDraw(drawContext.getMatrices(), I0O1l0I1.b("SGVzYXAgc2F5xLFzxLE6IA==") + this.accounts.size(), (float)centerX, (float)(buttonsY + inputHeight + 60), -1);
   ...
   private void drawConfirmDialog(DrawContext drawContext) {
      ...
      FontUtils.sf_bold[22]
         .centeredDraw(
            drawContext.getMatrices(),
            I0O1l0I1.b("VMO8bSBoZXNhcGxhcsSxIHNpbG1layBpc3RlZGnEn2luaXplIGVtaW4gbWlzaW5pej8="),
      ...
      FontUtils.sf_medium[20]
         .centeredDraw(
            drawContext.getMatrices(), I0O1l0I1.b("RXZldA=="), (float)yesX + (float)btnWidth / 2.0F, (float)btnY + (float)btnHeight / 2.0F - 6.0F, Color.WHITE.getRGB()
         );
      ...
      FontUtils.sf_medium[20]
         .centeredDraw(
            drawContext.getMatrices(), I0O1l0I1.b("SGF5xLFy"), (float)noX + (float)btnWidth / 2.0F, (float)btnY + (float)btnHeight / 2.0F - 6.0F, Color.WHITE.getRGB()
         );
   }
}
