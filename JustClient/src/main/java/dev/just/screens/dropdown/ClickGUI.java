...
public class ClickGUI extends Screen implements IMinecraft {
   ...
   public void render(DrawContext ctx, int mx, int my, float delta) {
      ...
      int textLight = new Color(180, 180, 190).getRGB();
      small.drawLeftAligned(ctx.getMatrices(), "Just Client", 8, height - 16, textLight);
      small.drawLeftAligned(ctx.getMatrices(), " by Lxrich", 8 + small.getWidth("Just Client"), height - 16, TEXT_GRAY);
