...
public class MacroCommand extends Command {
   ...
   public void execute(LiteralArgumentBuilder<CommandSource> builder) {
      ...
      RequiredArgumentBuilder<CommandSource, String> addMessageArg = (RequiredArgumentBuilder<CommandSource, String>)arg("message", StringArgumentType.greedyString())
         .executes(
            ctx -> {
               ...
               if (key == null) {
                  ClientManager.message(Formatting.RED + Strings.b("VHXFnyBidWx1bmFtYWTEsTog") + keyName);
                  return 1;
               } else {
                  ...
                  ClientManager.message(
                     ""
                        ...
                        + keyName
                        + Formatting.WHITE
                        + Strings.b("IHR1xZ91bmEg")
                        + Formatting.RED
                        + message
                        + Formatting.WHITE
                        + Strings.b("IGtvbXV0dXlsYSBtYWtybyBla2xlbmRpLg==")
                  );
                  return 1;
               }
            }
      ...
      RequiredArgumentBuilder<CommandSource, String> removeKeyArg = (RequiredArgumentBuilder<CommandSource, String>)arg("key", StringArgumentType.word())
         ...
         .executes(ctx -> {
            ...
            if (key == null) {
               ...
               if (macro == null) {
                  ClientManager.message(Formatting.RED + keyName + Strings.b("IHR1xZ91bmRhIGF0YW5txLHFnyBiaXIgbWFrcm8geW9rLg=="));
                  return 1;
               } else {
                  Manager.MACROS_MANAGER.deleteMacro(key);
                  ClientManager.message(Formatting.GREEN + keyName + Strings.b("IHR1xZ91bmRha2kgbWFrcm8gc2lsaW5kaS4="));
                  return 1;
               }
            }
         });
            ...
            .executes(
               ctx -> {
                  if (Manager.MACROS_MANAGER.getMacros().isEmpty()) {
                     ClientManager.message(Strings.b("TWFrcm8gbGlzdGVzaSBib8WfLg=="));
                  } else {
                     ClientManager.message(Formatting.GREEN + Strings.b("TWFrcm8gTGlzdGVzaTo="));
                     Manager.MACROS_MANAGER
                        ...
                        .forEach(
                           macro -> {
                              ...
                              ClientManager.message(
                                 Formatting.WHITE
                                    + Strings.b("S29tdXQ6IA==")
                                    + Formatting.RED
                                    + macro.getMessage()
                                    + Formatting.WHITE
                                    + Strings.b("LCBUdcWfOiA=")
                                    + Formatting.RED
                                    + keyName
                              );
                           }
      ...
      builder.then(literal("clear").executes(ctx -> {
         if (Manager.MACROS_MANAGER.getMacros().isEmpty()) {
            ClientManager.message(Formatting.RED + Strings.b("TWFrcm8gbGlzdGVzaSB6YXRlbiBib8WfLg=="));
         } else {
            Manager.MACROS_MANAGER.getMacros().clear();
            Manager.MACROS_MANAGER.updateFile();
            ClientManager.message(Formatting.GREEN + Strings.b("TWFrcm8gbGlzdGVzaSBiYcWfYXLEsXlsYSB0ZW1pemxlbmRpLg=="));
         }
