...
public class BlockESPCommand extends Command {
   ...
   private int addBlock(CommandContext<CommandSource> ctx) {
      ...
      if (color == null) {
         try {
            ...
            ClientManager.message(Formatting.RED + Strings.b("SGF0YSEg") + Formatting.WHITE + Strings.b("R2XDp2Vyc2l6IHJlbmsuIFJlbmsgYWTEsSB2ZXlhIEhFWCBrb2R1IGt1bGxhbiAow7ZybjogZmYwMGZmKQ=="));
            return 1;
         }
      }
      ...
      ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.WHITE + blockName + Strings.b("IGJsb8SfdSA=") + colorStr + Strings.b("IHJlbmdpeWxlIGVrbGVuZGku"));
      return 1;
   }
   ...
   private int removeBlock(CommandContext<CommandSource> ctx) {
      ...
      ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.WHITE + blockName + Strings.b("IGJsb8SfdSBsaXN0ZWRlbiBzaWxpbmRpLg=="));
      return 1;
   }
