...
public class HclipCommand extends Command {
   ...
   private void teleport(double offset) {
      if (offset == 0.0) {
         ClientManager.message(Formatting.RED + Strings.b("SGF0YSEg") + Formatting.WHITE + "Mesafe 0 olamaz.");
      } else {
         ...
         ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.WHITE + Strings.b("xLBsZXJpIA==") + Formatting.GOLD + (int)offset + Formatting.WHITE + Strings.b("IGJsb2sgxLHFn8SxbmxhbmTEsW4u"));
      }
   }
}
