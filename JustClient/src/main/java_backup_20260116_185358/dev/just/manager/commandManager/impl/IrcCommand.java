   ...
   public void execute(LiteralArgumentBuilder<CommandSource> builder) {
      RequiredArgumentBuilder<CommandSource, String> ignoreArg = (RequiredArgumentBuilder<CommandSource, String>)(RequiredArgumentBuilder<?, ?>)RequiredArgumentBuilder.argument(
         ...
         .executes(context -> {
            ...
            Manager.IRC_MANAGER.messageClient(nick + Strings.b("IGVuZ2VsbGVuZW5sZXJlIGVrbGVuZGku"));
            return 1;
         });
      ...
      RequiredArgumentBuilder<CommandSource, String> unignoreArg = (RequiredArgumentBuilder<CommandSource, String>)(RequiredArgumentBuilder<?, ?>)RequiredArgumentBuilder.argument(
         ...
         .executes(context -> {
            ...
            Manager.IRC_MANAGER.messageClient(nick + Strings.b("IGVuZ2VsbGVtZSBsaXN0ZXNpbmRlbiDDp8Sxa2FyxLFsZMSxLg=="));
            return 1;
         });
      ...
      builder.then(literal("ignorelist").executes(context -> {
         if (Manager.IRC_MANAGER.getIgnoredNicks().isEmpty()) {
            Manager.IRC_MANAGER.messageClient(Strings.b("RW5nZWxsZW5lbmxlciBsaXN0ZXNpIGJvxZ8u"));
         } else {
            Manager.IRC_MANAGER.messageClient(Strings.b("RW5nZWxsZW5lbmxlcjog") + String.join(", ", Manager.IRC_MANAGER.getIgnoredNicks()));
         }
      ...
      RequiredArgumentBuilder<CommandSource, String> msgArg = (RequiredArgumentBuilder<CommandSource, String>)(RequiredArgumentBuilder<?, ?>)RequiredArgumentBuilder.argument(
         ...
         .executes(context -> {
            ...
            if (message.matches("(https?://|www\\.)\\S+")) {
               Manager.IRC_MANAGER.messageClient(Strings.b("TWVzYWrEsW7EsXogYmlyIGJhxJ9sYW50xLEgacOnZXJpeW9yIChMaW5rIHBheWxhxZ/EsW3EsSB5YXNha3TEsXIpLg=="));
               return 1;
            } else {
               if (Manager.FUNCTION_MANAGER.irc.state) {
                  Manager.IRC_MANAGER.messageHost(message);
               } else {
                  Manager.IRC_MANAGER.messageClient(Strings.b("TMO8dGZlbiDDtm5jZSBJUkMgbW9kw7xsw7xuw7wgYWt0aWYgZWRpbi4="));
               }
