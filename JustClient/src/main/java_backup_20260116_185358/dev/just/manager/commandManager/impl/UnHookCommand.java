   ...
   private void savePath(String path) {
      try {
         ...
         try (FileWriter writer = new FileWriter(CUSTOM_PATH_FILE, false)) {
            ...
            ClientManager.message(Formatting.GREEN + Strings.b("RG9zeWEgeW9sdSBrYXlkZWRpbGRpOiA=") + Formatting.WHITE + path);
         }
      } catch (IOException var7) {
         ClientManager.message(Formatting.RED + Strings.b("WW9sIGtheWRlZGlsaXJrZW4gaGF0YSBvbHXFn3R1OiA=") + var7.getMessage());
      }
   }
}
