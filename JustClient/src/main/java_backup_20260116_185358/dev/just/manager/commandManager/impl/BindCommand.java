...
public class BindCommand extends Command {
   ...
   private void listBoundKeys() {
      ClientManager.message(Formatting.GRAY + Strings.b("VMO8bSBNb2TDvGxsZXJpbiBMaXN0ZXNpOg=="));
   ...
   private void clearAllBindings() {
      ...
      ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.WHITE + Strings.b("VMO8bSB0dcWfIGF0YW1hbGFyxLEgdGVtaXpsZW5kaS4="));
   }
   ...
   private void addKeyBinding(String moduleName, String keyName) {
      ...
      if (module == null) {
         ClientManager.message(Formatting.RED + Strings.b("SGF0YSEg") + Formatting.WHITE + moduleName + Strings.b("IG1vZMO8bMO8IGJ1bHVuYW1hZMSxLg=="));
      } else if (key == -1) {
         ClientManager.message(Formatting.RED + Strings.b("SGF0YSEg") + Formatting.WHITE + keyName + Strings.b("IHR1xZ91IGJ1bHVuYW1hZMSxLg=="));
      } else {
         module.bind = key;
         ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.GOLD + module.name + Formatting.WHITE + Strings.b("IG1vZMO8bMO8IA==") + Formatting.GOLD + keyName + Formatting.WHITE + Strings.b("IHR1xZ91bmEgYXRhbmTEsS4="));
      }
   }
   ...
   private void removeKeyBinding(String moduleName, String keyName) {
      ...
      if (module == null) {
         ...
         module.bind = 0;
         ClientManager.message(Formatting.GREEN + Strings.b("QmHFn2FyxLFsxLEhIA==") + Formatting.GOLD + module.name + Formatting.WHITE + Strings.b("IG1vZMO8bMO8bsO8biB0dcWfIGF0YW1hc8SxIGthbGTEsXLEsWxkxLEu"));
      }
   }
}
