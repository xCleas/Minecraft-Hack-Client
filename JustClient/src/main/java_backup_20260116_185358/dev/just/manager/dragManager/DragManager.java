...
public class DragManager implements IMinecraft {
   ...
   public void init() {
      if (!this.DRAG_DATA.exists()) {
         System.out.println(Strings.b("U8O8csO8a2xlbmViaWxpciDDtsSfZSBwb3ppc3lvbiBkb3N5YXPEsSBidWx1bmFtYWTEsS4gS2F5xLF0IHNvbnJhc8SxIHllbmkgYmlyIGRvc3lhIG9sdcWfdHVydWxhY2FrLg=="));
      } else {
         try {
            ...
            if (loadedDrags != null) {
               ...
               System.out.println(Strings.b("U8O8csO8a2xlbmViaWxpciDDtsSfZWxlcmluIHBvemlzeW9ubGFyxLEgZG9zeWFkYW4gecO8a2xlbmRpLg=="));
            } else {
               System.out.println(Strings.b("RG9zeWFkYWtpIHZlcmlsZXIgYm/FnyB2ZXlhIGhhdGFsxLEu"));
            }
   ...
   public void save() {
      ...
      try (FileWriter writer = new FileWriter(this.DRAG_DATA)) {
         ...
         System.out.println(Strings.b("U8O8csO8a2xlbmViaWxpciDDtsSfZSBwb3ppc3lvbmxhcsSxIGJhxZ9hcsSxeWxhIGtheWRlZGlsZGk6IA==") + this.DRAG_DATA.getAbsolutePath());
