...
public class ProxyManager implements IMinecraft {
   ...
   public void init() {
      try {
         if (!this.CONFIG_PATH.exists() && !this.CONFIG_PATH.createNewFile()) {
            System.out.println(Strings.b("UHJveHkgeWFwxLFsYW5kxLFybWEgZG9zeWFzxLEgb2x1xZ90dXJ1bHVya2VuIGhhdGEgb2x1xZ90dS4="));
            return;
         }
         ...
         System.out.println(Strings.b("UHJveHkgeWFwxLFsYW5kxLFybWFzxLEgb2t1bnVya2VuIGhhdGEgb2x1xZ90dS4="));
   ...
   public void saveConfig() {
      try {
         ...
         System.out.println(Strings.b("UHJveHkgeWFwxLFsYW5kxLFybWFzxLEga2F5ZGVkaWxpcmtlbiBoYXRhIG9sdcWfdHUu"));
