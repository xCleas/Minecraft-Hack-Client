...
public class GuiProxy extends Screen {
   ...
   public GuiProxy(Screen parentScreen) {
      super(Text.literal(Strings.b("UHJveHkgQXlhcmxhcsSx")));
   ...
   private boolean checkProxy() {
      if (!isValidIpPort(this.ipPort.getText())) {
         this.msg = Formatting.RED + Strings.b("R2XDp2Vyc2l6IFBvcnQh");
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float partialTicks) {
      ...
      context.drawTextWithShadow(this.textRenderer, Strings.b("UHJveHkgVGlwaQ=="), this.positionX - 65, this.positionY[1] + 5, 10518656);
      context.drawCenteredTextWithShadow(this.textRenderer, Strings.b("S2ltbGlrIERvxJ9ydWxhbWE="), this.width / 2, this.positionY[3] + 8, Formatting.WHITE.getColorValue());
   ...
   public void init() {
      ...
      this.username.setPlaceholder(Text.literal(Strings.b("S3VsbGFuxLFjxLEgQWTEsQ==")));
      ...
      this.password.setPlaceholder(Text.literal(Strings.b("xZ5pZnJl")));
