...
public final class ConfigManager implements IMinecraft {
   ...
   public void init() throws Exception {
      if (!this.CONFIG_DIR.exists()) {
         ...
         System.out.println(Strings.b("WytdIE90b21hdGlrIHlhcMSxbGFuZMSxcm1hIHnDvGtsZW5peW9yLi4u"));
      } else {
         System.out.println(Strings.b("Wy1dIE90b21hdGlrIHlhcMSxbGFuZMSxcm1hIGRvc3lhc8SxIGJ1bHVuYW1hZMSx"));
   ...
   public void loadConfiguration(String configuration, boolean start) {
      ...
      if (config == null) {
         ClientManager.message(Strings.b("WWFwxLFsYW5kxLFybWEgZG9zeWFzxLEgJw==") + configuration + Strings.b("JyBidWx1bmFtYWTEsSE="));
      } else {
         try {
            JsonElement element = this.readJsonFromFile(config.getFile());
            if (element != null && element.isJsonObject()) {
               config.load(element.getAsJsonObject(), configuration, start);
               ClientManager.message(Strings.b("WWFwxLFsYW5kxLFybWEgJw==") + configuration + Strings.b("JyBiYcWfYXLEsXlsYSB5w7xrbGVuZGku"));
            } else {
               this.saveConfiguration(configuration);
               ClientManager.message(Strings.b("WWFwxLFsYW5kxLFybWEgJw==") + configuration + Strings.b("JyBib3p1ayBvbGR1xJ91IHZleWEgYnVsdW5tYWTEscSfxLEgacOnaW4geWVuaWRlbiBvbHXFn3R1cnVsZHUu"));
            }
         } catch (JsonParseException var5) {
            ClientManager.message("'" + configuration + Strings.b("JyBkb3N5YXPEsW5kYWtpIEpTT04gdmVyaXNpIGF5csSxxZ90xLFyxLFsxLFya2VuIGhhdGEgb2x1xZ90dSE="));
         } catch (NullPointerException var6) {
            ClientManager.message("'" + configuration + Strings.b("JyB5YXDEsWxhbmTEsXJtYXPEsSBnw7xuY2VsIGRlxJ9pbCB2ZSB5w7xrbGVuZW1peW9yIQ=="));
         } catch (ClassCastException var7) {
            ClientManager.message("'" + configuration + Strings.b("JyB5YXDEsWxhbmTEsXJtYXPEsSBib8WfIHZleWEgaGF0YWzEsSB2ZXJpIGnDp2VyaXlvciE="));
         }
      }
   }
   ...
   public void saveConfiguration(String configuration) {
      ...
      System.out.println(Strings.b("WytdIFlhcMSxbGFuZMSxcm1hICc=") + configuration + Strings.b("JyBiYcWfYXLEsXlsYSBrYXlkZWRpbGRpLg=="));
   }
      ...
      if (configName != null) {
         ...
         if (config != null) {
            ...
            if (file.exists()) {
               ...
               if (!deleted) {
                  System.out.println(Strings.b("WWFwxLFsYW5kxLFybWEgZG9zeWFzxLEgc2lsaW5lbWVkaTogIA==") + file.getAbsolutePath());
               }
            }
         }
      }
