...
public class ElytraTarget extends Function {
   public final ModeSetting mode = new ModeSetting(Strings.b("VcOndcWfIE1vZHU="), Strings.b("Tm9ybWFs"), Strings.b("Tm9ybWFs"), Strings.b("R2VsacWfbWnFnw=="));
   private final SliderSetting sila = new SliderSetting(Strings.b("VcOndcWfIEjEsXrEsQ=="), 8.0, 5.0, 40.0, 1.0, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")));
   private final SliderSetting silaTime = new SliderSetting(Strings.b("TWFuZXZyYSBTw7xyZXNp"), 400.0, 200.0, 1000.0, 10.0, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")));
   private final BindBooleanSetting perelet = new BindBooleanSetting(Strings.b("SGVkZWYgVGFobWluaQ=="), true);
   private final SliderSetting predict = new SliderSetting(Strings.b("VGFobWluIEhhc3Nhc2l5ZXRp"), 2.6F, 0.1F, 6.0, 0.1F, () -> this.perelet.get());
   private final BooleanSetting leaveHP = new BooleanSetting(Strings.b("T3RvbWF0aWsgS2HDp8SxxZ8="), true, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")));
   private final MultiSetting leaveList = new MultiSetting(
      Strings.b("S2HDp8SxxZ8gS2/Fn3VsbGFyxLE="),
      Arrays.asList(Strings.b("RMO8xZ/DvGsgQ2Fu"), Strings.b("RcWfeWEgS3VsbGFuxLFya2Vu"), Strings.b("S2Fsa2FuIFRha8SxbMSxeWtlbg==")),
      List.of(Strings.b("RMO8xZ/DvGsgQ2Fu"), Strings.b("RcWfeWEgS3VsbGFuxLFya2Vu")),
      () -> this.leaveHP.get() && this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final BindBooleanSetting resolver = new BindBooleanSetting(
      Strings.b("VnVydcWfIFNhcHTEsXLEsWPEsQ=="), true, Strings.b("SGF2YWRhIHNhcnPEsWxhcmFrIHJha2liaW4gc2l6ZSB2dXJtYXPEsW7EsSB6b3JsYcWfdMSxcsSxcg=="), () -> this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final SliderSetting resolverStrength = new SliderSetting(
      Strings.b("U2FwdMSxcm1hIMWeaWRkZXRp"), 12.0, 4.0, 30.0, 1.0, () -> this.resolver.get() && this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   public final BindBooleanSetting prefer = new BindBooleanSetting(
      Strings.b("RGluYW1payBZw7Zu"), true, Strings.b("SGFzYXIgYWxkxLHEn8SxbsSxemRhIG90b21hdGlrIG9sYXJhayB1w6d1xZ8gecO2bsO8bsO8IGRlxJ9pxZ90aXJpcg=="), () -> this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final MultiSetting preferDir = new MultiSetting(
      Strings.b("S2HDp8SxxZ8gWcO2bmxlcmk="),
      Arrays.asList(Strings.b("S3V6ZXk="), Strings.b("R8O8bmV5"), Strings.b("QmF0xLE="), Strings.b("RG/En3U="), Strings.b("WXVrYXLEsQ==")),
      List.of(Strings.b("S3V6ZXk="), Strings.b("R8O8bmV5"), Strings.b("QmF0xLE="), Strings.b("RG/En3U="), Strings.b("WXVrYXLEsQ=="), Strings.b("QcWfYcSfxLE=")),
      () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")) && this.prefer.get()
   );
   private final BooleanSetting avoidWalls = new BooleanSetting(
      Strings.b("RW5nZWxkZW4gS2HDp8Sxbm1h"), true, Strings.b("w5Zuw7xuw7x6ZGUgYmlyIGVuZ2VsIHZleWEgZHV2YXIgdmFyc2Egcm90YXnEsSBkZcSfacWfdGlyaXI="), () -> this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final BooleanSetting firework = new BooleanSetting(Strings.b("T3RvbWF0aWsgSGF2YWkgRmnFn2Vr"), true, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")));
   private final SliderSetting fireworkTime = new SliderSetting(
      Strings.b("RmnFn2VrIEt1bGxhbsSxbSBIxLF6xLE="), 800.0, 100.0, 2000.0, 10.0, () -> this.firework.get() && this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final BooleanSetting fakelags = new BooleanSetting("Fake Lagg", true, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")));
   private final SliderSetting fakelagsDistance = new SliderSetting(
      Strings.b("R2VjaWttZSBNZXNhZmVzaQ=="), 10.0, 5.0, 20.0, 0.5, () -> this.fakelags.get() && this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   private final SliderSetting fakelagsMaxDistance = new SliderSetting(
      Strings.b("TWFrc2ltdW0gVGFraXAgTWVzYWZlc2k="), 30.0, 15.0, 50.0, 1.0, () -> this.fakelags.get() && this.mode.is(Strings.b("R2VsacWfbWnFnw=="))
   );
   ...
   private final BooleanSetting visual = new BooleanSetting(Strings.b("UG96aXN5b251IGfDtnN0ZXI="), false, () -> this.mode.is(Strings.b("R2VsacWfbWnFnw==")) || this.mode.is(Strings.b("Tm9ybWFs")));
   ...
   private final Map<String, Vec3d> namedDirections = Map.of(
      ...
      Strings.b("RG/En3U="),
      new Vec3d(1.0, 0.0, 0.0),
      Strings.b("WXVrYXLEsQ=="),
      new Vec3d(0.0, 1.0, 0.0),
      Strings.b("QcWfYcSfxLE="),
      new Vec3d(0.0, -1.0, 0.0)
   );
   ...
   private void rebuildAirDirections() {
      ...
      for (String name : this.preferDir.getAvailableModes()) {
         if (this.preferDir.get(name) && (!name.equals(Strings.b("QcWfYcSfxLE=")) || isFlying)) {
      ...
      if (this.airDirections.isEmpty()) {
         for (Entry<String, Vec3d> entry : this.namedDirections.entrySet()) {
            if (!entry.getKey().equals(Strings.b("QcWfYcSfxLE=")) || isFlying) {
   ...
   public void onEvent(Event event) {
      if (this.mode.is(Strings.b("R2VsacWfbWnFnw==")) && mc.player.isGliding()) {
   ...
   private boolean shouldLeave() {
      boolean lowHP = mc.player.getHealth() <= 4.0F && this.leaveList.get(Strings.b("QXogY2Fu"));
      boolean usingItem = mc.player.isUsingItem()
         && !mc.player.getActiveItem().isOf(Items.SHIELD)
         && this.leaveList.get(Strings.b("RcWfeWEga3VsbGFuxLFya2Vu"));
