...
public class CrystalAura extends Function {
   private final MultiSetting options = new MultiSetting(
      Strings.b("QXlhcmxhcg=="),
      List.of(Strings.b("U2VsZi1EYW1hZ2UgRW5nZWxsZQ=="), Strings.b("SGFyZWtldCBEw7x6ZWx0bWU="), Strings.b("RMO8xZ9lbiBPeXVuY3U="), Strings.b("QmxvayBWdXJndWxhbWE=")),
      new String[]{Strings.b("U2VsZi1EYW1hZ2UgRW5nZWxsZQ=="), Strings.b("SGFyZWtldCBEw7x6ZWx0bWU="), Strings.b("RMO8xZ9lbiBPeXVuY3U="), Strings.b("QmxvayBWdXJndWxhbWE=")}
   );
   private final ModeSetting distanceMode = new ModeSetting(Strings.b("TWVuemxsIFRpcGk="), Strings.b("w5Z6ZWw="), Strings.b("w5Z6ZWw="), "Grim");
   private final SliderSetting customDistance = new SliderSetting(Strings.b("TWVuemls"), 5.0, 2.5, 6.0, 0.05F, () -> this.distanceMode.is(Strings.b("w5Z6ZWw=")));
   private final SliderSetting breakDelay = new SliderSetting(Strings.b("R2VjaWttZQ=="), 100.0, 0.0, 500.0, 1.0);
   public final BooleanSetting offHandCrystal = new BooleanSetting(Strings.b("U29sIEVsZSBLcmlzdGFsIEFs"), true);
   private final BooleanSetting renderBlock = new BooleanSetting(Strings.b("QmxvayBSZW5kZXI="), true);
   private final BooleanSetting rgCheck = new BooleanSetting(Strings.b("QsO2bGdlIEtvbnRyb2zDvA=="), true, Strings.b("Q2xhaW1saSBiw7ZsZ2VsZXJpIGtvbnRyb2wgZWRlcg=="));
   private final BooleanSetting twoPlace = new BooleanSetting(Strings.b("w4dva2x1IFllcmxlxZ90aXJtZQ=="), true);
   ...
   public boolean check() {
      return (this.closestObsidian != null || this.closestCrystal != null) && this.rotate != null && this.options.get(Strings.b("SGFyZWtldCBEw7x6ZWx0bWU="));
   }
               ...
               if (e instanceof LivingEntity) {
                  ...
                  if (e != mc.player && e.isAlive()) {
                     ...
                     if (pos != null) {
                        ...
                        if ((!this.options.get(Strings.b("U2VsZi1EYW1hZ2UgRW5nZWxsZQ==")) || !(this.calculateCrystalDamage(pos, mc.player) > 6.0)) && damage > bestDamage) {
                           bestDamage = damage;
   ...
   private BlockPos findBestCrystalPosition(LivingEntity target, double maxDist) {
      ...
      for (BlockPos airPos : positions) {
         ...
         if (!baseBlock.equals(mc.player.getBlockPos().down()) && this.canPlaceCrystal(baseBlock, maxDist)) {
            ...
            if ((!this.options.get(Strings.b("U2VsZi1EYW1hZ2UgRW5nZWxsZQ==")) || !(selfDamage > 6.0)) && damage > bestDamage) {
               bestDamage = damage;
               bestPos = baseBlock;
            }
         }
