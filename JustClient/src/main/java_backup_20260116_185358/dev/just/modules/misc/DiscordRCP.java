   ...
   public synchronized void startRpc() {
      ...
      new Thread(() -> {
         try {
            ...
            if (this.ipc.connect()) {
               System.out.println(Strings.b("W0p1c3RDbGllbnRdIERpc2NvcmQgUlBDIGJhxJ9sYW5kxLEh"));
               ...
               System.err.println(Strings.b("W0p1c3RDbGllbnRdIERpc2NvcmQgYnVsdW5hbWFkxLE="));
               this.started = false;
            }
         } catch (Exception e) {
            System.err.println(Strings.b("W0p1c3RDbGllbnRdIERpc2NvcmQgUlBDIGJhxZ9sYXTEsWxhbWFkxLE6IA==") + e.getMessage());
            this.started = false;
         }
   ...
   private void updatePresence() {
      ...
      try {
         ...
         this.ipc.updatePresence(
            Strings.b("SnVzdCBDbGllbnQgT3ludXlvcg=="),           // details
            Strings.b("S3VsbGFuxLFjxLE6IA==") + username,        // state
            "icon",                          // largeImageKey
