...
public class TPLoot extends Function {
   private final ModeSetting lootEnd = new ModeSetting(Strings.b("VG9wbGFkxLFrdGFuIFNvbnJh"), Strings.b("SGnDp2Jpcmk="), Strings.b("SGnDp2Jpcmk="), "/hub", "/spawn", "home", Strings.b("w5Z6ZWw="));
   private final TextSetting text = new TextSetting(Strings.b("S29tdXQ="), "/home home", () -> this.lootEnd.is("home"));
   private final TextSetting custom = new TextSetting(Strings.b("S29tdXQ="), "/test", () -> this.lootEnd.is(Strings.b("w5Z6ZWw=")));
         ...
         if (this.check && this.timerUtil.hasTimeElapsed(100L) && (this.isHotbar() || this.isInv())) {
            ...
            switch (var15) {
               ...
               case "home":
                  ...
                  break;
               default:
                  if (var15.equals(Strings.b("w5Z6ZWw="))) mc.player.networkHandler.sendChatMessage(this.custom.getValue());
            }
