...
public class HWHelper extends Function {
   private final BindSetting trapka = new BindSetting(Strings.b("VHJhcGthIFR1xZ91"), 0);
   private final BindSetting trapkaBax = new BindSetting(Strings.b("UGF0bGF5xLFjxLEgVHJhcGthIFR1xZ91"), 0);
   private final BindSetting stan = new BindSetting(Strings.b("U3RhbiBUdcWfdQ=="), 0);
   private final BindSetting snow = new BindSetting(Strings.b("S2FyIFRvcHUgVHXFn3U="), 0);
   private final BindSetting babax = new BindSetting(Strings.b("UGF0bGF5xLFjxLEgxZ5leSBUdcWfdQ=="), 0);
   private final BooleanSetting bypass = new BooleanSetting("Bypass", true, Strings.b("RcWfeWEgZGXEn2nFn2ltaSBzxLFyYXPEsW5kYSBzaXppIHlhdmHFn2xhdGFyYWsgYW50aWNoZWF0J2kgYXRsYXTEsXI="));
   private final BooleanSetting inventoryUse = new BooleanSetting(Strings.b("RW52YW50ZXJkZW4gS3VsbGFu"), true);
