...
public class KTLeave extends Function {
   private final ModeSetting mode = new ModeSetting(Strings.b("TW9k"), "Motion", "Motion", "Packet");
   private final BooleanSetting phase = new BooleanSetting(Strings.b("RHV2YXIgR2XDp21l"), false);
   private final BooleanSetting gravity = new BooleanSetting(Strings.b("WWVyw6dla2ltaQ=="), false);
   private final BooleanSetting automount = new BooleanSetting(Strings.b("T3RvIEJpbm1l"), false);
   private final BooleanSetting allowShift = new BooleanSetting(Strings.b("U2hpZnQgxLB6bmk="), false);
   private final SliderSetting speed = new SliderSetting(Strings.b("SMSxeg=="), 2.0, 0.0, 25.0, 0.1F);
   private final SliderSetting yspeed = new SliderSetting(Strings.b("WS1IxLF6xLE="), 1.0, 0.0, 10.0, 0.1F);
   private final BooleanSetting cancel = new BooleanSetting(Strings.b("xLBwdGFsIEV0"), false);
   private final BooleanSetting stopunloaded = new BooleanSetting(Strings.b("WcO8a2xlbm1lbWnFn3RlIER1cg=="), false);
   private final BooleanSetting cancelrotations = new BooleanSetting(Strings.b("Um90YXN5b251IMSwcHRhbCBFdA=="), false);
   private final BooleanSetting limit = new BooleanSetting(Strings.b("U8SxbsSxcmxh"), false);
   private final SliderSetting jitter = new SliderSetting(Strings.b("VGl0cmVtZQ=="), 0.1F, 0.0, 10.0, 0.1F);
   private final BooleanSetting spoofpackets = new BooleanSetting(Strings.b("UGFrZXQgWWFuxLFsdG1h"), false);
   private final BooleanSetting ongroundpacket = new BooleanSetting(Strings.b("WWVyZGUgUGFrZXRp"), false);
