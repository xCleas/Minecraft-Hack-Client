...
public class ElytraHelper extends Function {
   private final BindSetting elytraKey = new BindSetting(Strings.b("RWxpdHJhIFR1xZ91"), 0);
   private final BindSetting fireworkKey = new BindSetting(Strings.b("SGF2YWkgRmnFn2VrIFR1xZ91"), 0);
   private final BooleanSetting autoTakeoff = new BooleanSetting(Strings.b("T3RvbWF0aWsgS2Fsa8SxxZ8="), true);
         ...
         if (e.key == this.elytraKey.getKey()) {
            ...
            if (equipped.getItem() == Items.ELYTRA) {
               if (chestPlateSlot != -1) {
                  ...
                  ClientManager.message(Strings.b("xZ51bmEgZ2XDp2lsZGk6IA==") + Formatting.AQUA + Strings.b("WsSxcmg="));
               } else {
                  this.swapSlots(elytraSlot == -1 ? 6 : elytraSlot, 6);
                  ClientManager.message(Formatting.YELLOW + Strings.b("RWxpdHJhIMOnxLFrYXLEsWxkxLEgKFrEsXJoIGJ1bHVuYW1hZMSxKQ=="));
               }
            } else if (elytraSlot != -1) {
               this.swapSlots(elytraSlot, 6);
               ClientManager.message(Strings.b("xZ51bmEgZ2XDp2lsZGk6IA==") + Formatting.RED + "Elitra");
            } else {
               ClientManager.message(Formatting.RED + Strings.b("RWxpdHJhIGJ1bHVuYW1hZMSxIQ=="));
            }
         }
   ...
   protected void onEnable() {
      ClientManager.message(Strings.b("RGXEn2nFn2ltbGVyaW4gZMO8emfDvG4gw6dhbMSxxZ9tYXPEsSBpw6dpbiBsw7x0ZmVuIFZpYUZhYnJpY1BsdXMgw7x6ZXJpbmRlbiBzw7xyw7xtw7wgMS4xNyBvbGFyYWsgYXlhcmxhecSxbi4="));
      super.onEnable();
   }
}
