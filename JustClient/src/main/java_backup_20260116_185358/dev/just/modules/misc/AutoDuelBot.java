...
public class AutoDuelBot extends Function {
   private final ModeSetting chatMode = new ModeSetting(Strings.b("U29oYmV0"), Strings.b("WWVyZWw="), Strings.b("WWVyZWw="), "Global");
   private final SliderSetting minMoney = new SliderSetting(Strings.b("TWluIFBhcmE="), 1000.0, 1000.0, 1000000.0, 1000.0);
   private final SliderSetting maxMoney = new SliderSetting(Strings.b("TWF4IFBhcmE="), 1000000.0, 1000.0, 1000000.0, 1000.0);
   private final SliderSetting messageDelay = new SliderSetting(Strings.b("TWVzYWogR2VjaWttZXNp"), 5000.0, 3000.0, 30000.0, 1000.0);
   ...
   public void onEvent(Event event) {
      if (event instanceof EventUpdate) {
         if (this.timerUtil.hasTimeElapsed(this.messageDelay.get().longValue())) {
            String msg = Strings.b("SGVya2VzIGTDvGVsbG8gYXRzxLFuISBCYWhpczog") + this.minMoney.get().intValue() + Strings.b("IGlsZSA=") + this.maxMoney.get().intValue() + Strings.b("IGFyYXPEsS4=");
         ...
         if (text.contains("➝ Isim: ") || text.contains(Strings.b("4p6dIMSwc2ltOiA=")) || text.contains("➝ Name: ")) {
