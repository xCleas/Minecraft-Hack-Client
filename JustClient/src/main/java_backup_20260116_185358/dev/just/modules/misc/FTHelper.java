...
public class FTHelper extends Function {
   ...
   private final BindSetting disorientation = new BindSetting(Strings.b("RGV6b3J5YW50YXN5b24gVHXFn3U="), 0);
   private final BindSetting plast = new BindSetting(Strings.b("UGxhc3QgVHXFn3U="), 0);
   private final BindSetting godaura = new BindSetting(Strings.b("VGFucsSxIEF1cmFzxLEgVHXFn3U="), 0);
