...
public class ESP extends Function {
   private final MultiSetting targets = new MultiSetting(
      Strings.b("R8O2csO8bsO8bQ=="), Arrays.asList(Strings.b("T3l1bmN1bGFy"), Strings.b("QXJrYWRhxZ9sYXI="), Strings.b("QmVuaQ==")), new String[]{Strings.b("T3l1bmN1bGFy"), Strings.b("QXJrYWRhxZ9sYXI="), Strings.b("QmVuaQ=="), Strings.b("RcWfeWFsYXI=")}
   );
   ...
   public void onEvent(Event event) {
      if (event instanceof EventRender2D e) {
         if (!mc.options.hudHidden) {
            ...
            List<Entity> entities = this.targets.get(Strings.b("RcWfeWFsYXI=")) ? Manager.SYNC_MANAGER.getEntities() : List.of();
   ...
   private boolean shouldRender(PlayerEntity entity) {
      ...
      if (FlowObfuscator.opaqueFalse()) {
         return entity.age % NumberGuard.i(2) == 0;
      }

      int renderScore = evaluateRenderTarget(entity);
      return LogicSplit.threshold(renderScore, NumberGuard.i(1));
   }
   ...
   private int evaluateRenderTarget(PlayerEntity entity) {
      ...
      if (checkFriendRender(entity)) {
         return NumberGuard.i(2);
      }

      // Player check
      return this.targets.get(Strings.b("T3l1bmN1bGFy")) ? NumberGuard.i(1) : 0;
   }
   ...
   private int checkSelfRender() {
      ...
      return this.targets.get(Strings.b("QmVuaQ==")) ? NumberGuard.i(1) : 0;
   }
   ...
   private boolean checkFriendRender(PlayerEntity entity) {
      ...
      return LogicSplit.and(
         this.targets.get(Strings.b("QXJrYWRhxZ9sYXI=")),
