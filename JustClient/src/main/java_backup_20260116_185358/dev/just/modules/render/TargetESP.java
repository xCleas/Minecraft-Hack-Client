...
public class TargetESP extends Function {
   private final ModeSetting mode = new ModeSetting(Strings.b("TW9k"), Strings.b("RGFpcmU="), "Isaretci", "Isaretci2", Strings.b("SGF5YWxldGxlcg=="), Strings.b("RGFpcmU="));
   ...
   public TargetESP() {
      ...
      for (int i = 0; i <= 100; i++) {
         this.SCALE_CACHE[i] = Math.max(NumberGuard.f(0.28F) * ((float)i / NumberGuard.f(100.0F)), NumberGuard.f(0.2F));
      }
   }
  ...
  public void onEvent(Event event) {
   ...
   private void handleRenderInternal(EventRender3D renderEvent) {
      ...
      if (FlowObfuscator.opaqueTrue() && currentTarget != null) {
         if (this.mode.is("Isaretci") || this.mode.is("Isaretci2")) {
            this.render(currentTarget);
         } else if (this.mode.is(Strings.b("SGF5YWxldGxlcg=="))) {
            this.renderGhosts(NumberGuard.i(14), NumberGuard.i(8), NumberGuard.f(1.8F), NumberGuard.f(3.0F), currentTarget);
         } else if (this.mode.is(Strings.b("RGFpcmU="))) {
