...
public class SwingAnimations extends Function {
   private final ModeSetting mode = new ModeSetting(
      Strings.b("QW5pbWFzeW9uIFTDvHLDvA=="), "Smooth", "Smooth", "Block", "ToBack", "SelfBack", "360", "Down", "Glide", "DropDown", "DeadCode"
   );
   public final BooleanSetting slowAnimation = new BooleanSetting(Strings.b("WWF2YcWfbGF0bWE="), false);
   public final SliderSetting slowAnimationSpeed = new SliderSetting(Strings.b("WWF2YcWfbGF0bWEgSMSxesSx"), 12.0, 1.0, 50.0, 1.0, () -> this.slowAnimation.get());
   private final SliderSetting corner = new SliderSetting(Strings.b("S8O2xZ9lIEHDp8Sxc8Sx"), 12.0, 1.0, 360.0, 1.0);
   private final SliderSetting slant = new SliderSetting(Strings.b("RcSfaW0gQcOnxLFzxLE="), 12.0, 1.0, 360.0, 1.0);
