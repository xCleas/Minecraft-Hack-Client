...
public class HUD extends Function {
   public final MultiSetting setting = new MultiSetting(
      Strings.b("RWxlbWVudGxlcg=="),
      Arrays.asList(Strings.b("WsSxcmhIVUQ=")),
      new String[]{Strings.b("WsSxcmhIVUQ=")}
   );
   private final ModeSetting hudColor = new ModeSetting(Strings.b("SFVEIHJlbmdp"), "Normal", "Normal", Strings.b("VGVtYXlhIGJhxJ9sxLE="));
   private final ModeSetting gradientType = new ModeSetting(() -> this.hudColor.is(Strings.b("VGVtYXlhIGJhxJ9sxLE=")), Strings.b("R3JhZHlhbiB0aXBp"), Strings.b("U29sZGFuIHNhxJ9h"), Strings.b("U29sZGFuIHNhxJ9h"), Strings.b("U2HEn2RhbiBzb2xh"));
   private final SliderSetting customAlpha = new SliderSetting(Strings.b("U2F5ZGFtbMSxaw=="), 120.0, 120.0, 255.0, 5.0);
   private final BooleanSetting visibleCrosshair = new BooleanSetting(
      Strings.b("SGVkZWZlIGJha2Fya2VuIEhlZGVmIEh1ZCBnw7ZzdGVy"), false, Strings.b("SGVkZWZlIGJha2Fya2VuIEhlZGVmIEh1ZCd1IGfDtnN0ZXJpcg=="), () -> this.setting.get(Strings.b("SGVkZWYgSHVk"))
   );
   private final BooleanSetting blur = new BooleanSetting(Strings.b("QnVsYW7EsWtsxLFr"), false, Strings.b("VMO8bSBIVUQgZWxlbWVudGxlcmluZSBidWxhbsSxa2zEsWsgdXlndWxhcg=="));
   private final SliderSetting roundingSilaSanya = new SliderSetting(Strings.b("S2FmYSB5dXZhcmxhbWE="), 2.0, 0.0, 12.0, 1.0);
   ...
   public final Dragging keybindsDrag = JustClient.getInstance().createDrag(this, Strings.b("VHXFn0F0YW1hbGFyxLFIVUQ="), 10.0F, 95.0F);
   public final Dragging stafflistDrag = JustClient.getInstance().createDrag(this, "PersonelListesiHUD", 10.0F, 128.0F);
   public final Dragging itemcooldownDrag = JustClient.getInstance().createDrag(this, Strings.b("QmVrbGVtZVPDvHJlc2lIVUQ="), 10.0F, 165.0F);
   public final Dragging potionhudDrag = JustClient.getInstance().createDrag(this, Strings.b("xLBrc2lySFVE"), 10.0F, 198.0F);
   public final Dragging coordinateshudDrag = JustClient.getInstance().createDrag(this, "KoordinatlarHUD", 10.0F, 198.0F);
   public final Dragging armorDrag = JustClient.getInstance().createDrag(this, Strings.b("WsSxcmhIVUQ="), 478.0F, 468.0F);
   ...
   private void handleRenderInternal(EventRender2D eventRender2D) {
      ...
      if (FlowObfuscator.opaqueTrue() && this.setting.get(Strings.b("WsSxcmhIVUQ="))) {
   ...
   private void potion(EventRender2D eventRender2D) {
      ...
      if (this.hudColor.is("Normal")) {
         ...
         boolean leftToRight = this.gradientType.is(Strings.b("U29sZGFuIHNhxJ9h"));
   ...
   private void cooldown(EventRender2D eventRender2D) {
      ...
      FontUtils.durman[15].drawLeftAligned(eventRender2D.getDrawContext().getMatrices(), Strings.b("QmVrbGVtZSBTw7xyZWxlcmk="), posX + 10.0F, posY + 5.0F, -1);
      RenderUtil.drawRoundedRect(
         eventRender2D.getDrawContext().getMatrices(),
         posX,
         posY + (float)headerHeight - 1.0F,
   ...
   private void waterMark(EventRender2D render2D) {
      ...
      // Box 1: Just Client
      String clientText = "Just Client";
      float box1Width = titleFont.getWidth(clientText) + 24.0F;
      ...
      titleFont.drawLeftAligned(matrices, clientText, x + 12.0F, y + 6.0F, accentColor);
   ...
   static {
      ...
      tmp.put(Items.ENDER_PEARL, Strings.b("RW5kZXIgxLBuY2lzaQ=="));
      tmp.put(Items.CHORUS_FRUIT, Strings.b("S29ybyBNZXl2ZXNp"));
      tmp.put(Items.FIREWORK_ROCKET, Strings.b("RmnFn2Vr"));
      tmp.put(Items.SHIELD, "Kalkan");
      tmp.put(Items.GOLDEN_APPLE, Strings.b("QWx0xLFuIEVsbWE="));
      tmp.put(Items.ENCHANTED_GOLDEN_APPLE, Strings.b("QsO8ecO8bMO8IEFsdMSxbiBFbG1h"));
      tmp.put(Items.TOTEM_OF_UNDYING, Strings.b("w5Zsw7xtc8O8emzDvGsgVG90ZW1p"));
      tmp.put(Items.SNOWBALL, "Kartopu");
      tmp.put(Items.DRIED_KELP, Strings.b("S3VydXR1bG11xZ8gWW9zdW4="));
      tmp.put(Items.ENDER_EYE, Strings.b("RW5kZXIgR8O2esO8"));
      tmp.put(Items.NETHERITE_SCRAP, Strings.b("TmV0aGVyaXRlIFBhcsOnYXPEsQ=="));
      tmp.put(Items.EXPERIENCE_BOTTLE, Strings.b("VGVjcsO8YmUgxZ5pxZ9lc2k="));
      tmp.put(Items.PHANTOM_MEMBRANE, Strings.b("SGF5YWxldCBaYXLEsQ=="));
